...
Selection-aware Bayesian estimation for two-stage (informal → formal) M&A auctions.
...
- New candidates:
  ...
  - `cand4_type_spr_prec_z` (precision covariate is a type-demeaned, scaled log-tick residual)
